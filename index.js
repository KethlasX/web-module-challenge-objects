...
*/
console.log(createMenuItem('cookie', 3,'Pastry'));
console.log(createMenuItem('croissant', 2,'Pastry'));
console.log(createMenuItem('cinnamon roll', 5,'Pastry'));
...
function addReview(array, index, key, value){
